...
using System.Collections.Generic;
using System.Linq;
using AgentGL.Common;
using AgentGL.Error;
using AgentGL.Language.Lexer;
using AgentGL.Syntax.Expression;
using AgentGL.Syntax.Expression.Nodes;
using AgentGL.Syntax.Expression.Nodes.BlockNodes;
using AgentGL.Syntax.Expression.Nodes.LiteralNodes;
using AgentGL.Syntax.Lexeme;
using Classifier = AgentGL.Syntax.Lexeme.Classifier;

namespace AgentGL.Language.Parser
{
    public class Parser
    {
